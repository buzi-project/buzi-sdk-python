...
from buziv2 import rest
from buziv2.configuration import Configuration
from buziv2.exceptions import ApiTypeError, ApiValueError, ApiException
from buziv2.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'thunes-mt/0.202209251204.0/python'
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = SmsApi()
        api_instance.cancel_message  # this is an instance of the class Endpoint
        api_instance.cancel_message()  # this invokes api_instance.cancel_message.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.cancel_message.callable or self.callable in this class
